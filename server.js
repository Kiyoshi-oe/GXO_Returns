...
// Catch-All: Redirect zu Dashboard (aber nicht für API-Routes)
app.use((req, res, next) => {
  // API-Routes werden bereits vom notFoundHandler behandelt
